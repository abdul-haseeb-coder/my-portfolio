    ...
    <div>
      ...
      <section className="service">
        ...
        <ul className="service-list">
          ...
          <li className="service-item">
            <div className="service-icon-box">
              <Image src="/icon-app.svg" alt="mobile app icon" width="40" />
            </div>
          ...
          <li className="service-item">
            <div className="service-icon-box">
              <Image src="/icon-photo.svg" alt="camera icon" width="40" />
            </div>
      ...
      <div className="modal-container" data-modal-container>
        ...
        <section className="testimonials-modal">
          ...
          <div className="modal-Image-wrapper">
            ...
            <Image src="/icon-quote.svg" alt="quote icon" />
          </div>
      ...
      <section className="clients">
        ...
        <ul className="clients-list has-scrollbar">
          <li className="clients-item">
            <a href="#">
              <Image src="/logo-1-color.png" alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <Image src="/logo-2-color.png" alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <Image src="/logo-3-color.png" alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <Image src="/logo-4-color.png" alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <Image src="/logo-5-color.png" alt="client logo" />
            </a>
          </li>

          <li className="clients-item">
            <a href="#">
              <Image src="/logo-6-color.png" alt="client logo" />
            </a>
          </li>
        </ul>
      </section>
